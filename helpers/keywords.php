...
$words = frequencyBasedTags(getMsgs($dev, $path));
$numCommits = getCommitCount($dev, $path);

// Setup a basic canvas we can work
$g = new CanvasGraph(200, 50 + count($words) * 15,'auto');
...
$txt="Num Commits $numCommits\n\nWords based on Frequency\n";
foreach ($words as $word) {
	$txt .= "$word\n";
}

$t = new Text($txt,100,10);
